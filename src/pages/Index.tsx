...
const Index = () => {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-900 via-purple-900 to-blue-900 relative overflow-hidden">
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-slate-800/80 via-purple-800/80 to-slate-800/80 text-white py-3 backdrop-blur-sm border-b border-slate-700/50 relative z-10">
        <div className="px-4 text-center">
          <h1 className="text-xl font-bold bg-gradient-to-r from-white via-purple-200 to-cyan-200 bg-clip-text text-transparent mb-1">Datenerfassung</h1>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-4 relative z-10">
        <div className="w-full max-w-md">
          <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 border border-slate-700/50 rounded-xl shadow-2xl shadow-slate-900/50 backdrop-blur-sm overflow-hidden hover:shadow-purple-500/20 transition-all duration-500">
            <div className="bg-gradient-to-r from-purple-600 to-cyan-600 p-3 relative">
              <div className="absolute inset-0 bg-gradient-to-r from-purple-600/90 to-cyan-600/90 backdrop-blur-sm"></div>
              <div className="relative z-10">
                <h2 className="text-base font-bold text-white mb-1">Persönliche Informationen</h2>
                <p className="text-purple-100 text-xs">Bitte füllen Sie alle Felder aus und laden Sie Ihre Datei hoch</p>
              </div>
            </div>
            <div className="p-4">
              <FileUploadForm />
      ...
      {/* Footer */}
      <div className="bg-gradient-to-r from-slate-900/90 via-purple-900/90 to-slate-900/90 text-white py-3 backdrop-blur-sm border-t border-slate-700/50 relative z-10">
        <div className="px-4 text-center">
