...
>(({ value, onValueChange, placeholder, options, className }, ref) => {
  ...
  return (
    <div ref={containerRef} className={cn("relative", className)}>
      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 z-[9999] mt-1 max-h-96 overflow-hidden rounded-md border bg-slate-800 border-slate-700 text-gray-200 shadow-2xl shadow-slate-900/50 backdrop-blur-sm">
